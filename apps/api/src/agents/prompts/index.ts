...
export const AGENT_MODELS = {
  orchestrator: { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.2 },  // phân loại đơn giản
  content:      { provider: 'anthropic', model: 'claude-sonnet-4-5', temp: 0.8 },  // sáng tạo, follow instructions tốt
  evaluator:    { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.1 },  // chấm điểm cần nhất quán
  social:       { provider: 'openai',    model: 'gpt-4o',            temp: 0.5 },  // cần reasoning + web search
  offer:        { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.2 },  // so sánh số liệu, logic
  analyst:      { provider: 'anthropic', model: 'claude-sonnet-4-5', temp: 0.3 },  // phân tích phức tạp, báo cáo
  engage:       { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.7 },  // reply ngắn, volume cao
  rag:          { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.1 },  // tìm thông tin, cần nhất quán
  scheduler:    { provider: 'openai',    model: 'gpt-4o-mini',       temp: 0.3 },  // theo template, không cần flagship
} as const;
